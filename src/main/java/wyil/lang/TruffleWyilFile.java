...
//
//public class TruffleWyilFile {
//
//    public class TruffleWyilNode extends Node {
//        @Children
//        protected TruffleWyilNode[] children;
//
//        public AbstractSyntacticItem actualNode;
//
//        public TruffleWyilNode(AbstractSyntacticItem actualNode) {
//            this.actualNode = actualNode;
//            AbstractSyntacticItem[] operands = (AbstractSyntacticItem[]) actualNode.getAll();
//            this.children = new TruffleWyilNode[operands.length];
//            for (int i = 0; i < operands.length; i++) {
//                children[i] = new TruffleWyilNode(operands[i]);
//            }
//        }
//
