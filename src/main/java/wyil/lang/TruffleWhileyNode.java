...
public abstract class TruffleWhileyNode<S extends AbstractSyntacticItem> extends Node{

    @Children
    protected TruffleWhileyNode[] children;

    protected S actualNode;

    public TruffleWhileyNode(S actualNode) {
        this.actualNode = actualNode;

        SyntacticItem[] operands = actualNode.getAll();
        if (operands != null) {
            this.children = new TruffleWhileyNode[operands.length];
            for (int i = 0; i < operands.length; i++) {
//                children[i] = new TruffleWhileyNode<>(operands[i]);
                if (operands[i] instanceof Decl.Method) {
                    children[i] = new DeclNode.MethodNode((Decl.Method) operands[i]);
                } else if (operands[i] instanceof Decl.Variable) {
                    children[i] = new DeclNode.VariableNode((Decl.Variable) operands[i]);
                } else if (operands[i] instanceof Stmt.Return) {
                    children[i] = new StmtNode.ReturnNode((Stmt.Return) operands[i]);
                } else if (operands[i] instanceof Stmt.Block) {
                    children[i] = new StmtNode.BlockNode((Stmt.Block) operands[i]);
                } else if (operands[i] instanceof Expr.Constant) {
                    children[i] = new ExprNode.ConstantNode((Expr.Constant) operands[i]);
                } else if (operands[i] instanceof Type.Int) {
                    children[i] = new TypeNode.IntNode((Type.Int) operands[i]);
                } else if (operands[i] instanceof Modifier.Public) {
                    children[i] = new ModifierNode.PublicNode((Modifier.Public) operands[i]);
                } else if (operands[i] instanceof Modifier.Export) {
                    children[i] = new ModifierNode.ExportNode((Modifier.Export) operands[i]);
                } else if (operands[i] instanceof Tuple) {
                    children[i] = new TupleNode((Tuple) operands[i]);
                } else if (operands[i] instanceof Identifier) {
                    children[i] = new IdentifierNode((Identifier) operands[i]);
                } else if (operands[i] instanceof Value.Int) {
                    children[i] = new ValueNode.IntNode((Value.Int) operands[i]);
                } else {
                    System.err.println("invalid Node with type"+operands[i].toString());
                }
            }
        }
    }

    public S getActualNode() {
        return actualNode;
    }

    public SyntacticHeap getHeap() {
        return actualNode.getHeap();
    }

    public void allocate(SyntacticHeap heap, int index) {
        actualNode.allocate(heap, index);
    }
    ...
    public <T extends SyntacticItem> T getParent(Class<T> kind) {
        return actualNode.getParent(kind);
    }
    ...
    public <T extends SyntacticItem> List<T> getParents(Class<T> kind) {
        return actualNode.getParents(kind);
    }
    ...
    public <T extends SyntacticItem> T getAncestor(Class<T> kind) {
        return actualNode.getAncestor(kind);
    }

    public int getOpcode() {
        return actualNode.getOpcode();
    }

    public void setOpcode(int opcode) {
        actualNode.setOpcode(opcode);
    }

    public int size() {
        return actualNode.size();
    }

    public SyntacticItem get(int i) {
        return actualNode.get(i);
    }

    public void setOperand(int ith, SyntacticItem child) {
        actualNode.setOperand(ith, child);
    }

    public <T> T[] toArray(Class<T> elementKind) {
        return actualNode.toArray(elementKind);
    }

    public int getIndex() {
        return actualNode.getIndex();
    }

    public SyntacticItem[] getAll() {
        return actualNode.getAll();
    }
    ...
    public <S extends SyntacticItem> S match(Class<S> kind) {
        return actualNode.match(kind);
    }

    public int hashCode() {
        return actualNode.hashCode();
    }

    public boolean equals(Object o) {
        return actualNode.equals(o);
    }

    public String toString() {
        return actualNode.toString();
    }

    public int compareTo(SyntacticItem other) {
        return actualNode.compareTo(other);
    }
...
//    }
     ...
     *
     */
    public static interface DeclNode extends CompilationUnit.Declaration {

//        public static class UnknownNode extends TruffleWhileyNode<Decl.Unknown> implements DeclNode{
//
//            public UnknownNode(Decl.Unknown actualNode) {
//                super(actualNode);
//            }
//
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return actualNode.clone(operands);
//            }
//
//            public static final Descriptor DESCRIPTOR_0 = Decl.Unknown.DESCRIPTOR_0; // {
////                @SuppressWarnings("unchecked")
////                @Override
////                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
////                    return WyilFile.Decl.Unknown.DESCRIPTOR_0.construct(opcode, operands, ;);
////                }
////            };
//        }
...
//         *
//         */
//        public static class ModuleNode extends AbstractSyntacticItem {
//
//            public Module(AbstractCompilationUnit.Name name, AbstractCompilationUnit.Tuple<Unit> modules, AbstractCompilationUnit.Tuple<Unit> externs,
//                          AbstractCompilationUnit.Tuple<Marker> attributes) {
//                super(DECL_module, name, modules, externs, attributes);
//            }
//
//            public AbstractCompilationUnit.Name getName() {
//                return (AbstractCompilationUnit.Name) get(0);
//            }
//
//            public AbstractCompilationUnit.Tuple<Unit> getUnits() {
//                return (AbstractCompilationUnit.Tuple<Unit>) get(1);
//            }
//
//            public AbstractCompilationUnit.Tuple<Unit> getExterns() {
//                return (AbstractCompilationUnit.Tuple<Unit>) get(2);
//            }
//
//            public AbstractCompilationUnit.Tuple<Marker> getAttributes() {
//                return (AbstractCompilationUnit.Tuple<Marker>) get(3);
//            }
//
...
//            }
//
//            public void setAttributes(AbstractCompilationUnit.Tuple<Marker> attributes) {
//                setOperand(3, getHeap().allocate(attributes));
//            }
//
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Module((AbstractCompilationUnit.Name) operands[0], (AbstractCompilationUnit.Tuple<Unit>) operands[1], (AbstractCompilationUnit.Tuple<Unit>) operands[2],
//                        (AbstractCompilationUnit.Tuple<Marker>) operands[3]);
//            }
//
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new Module((AbstractCompilationUnit.Name) operands[0], (AbstractCompilationUnit.Tuple<Unit>) operands[1],
//                            (AbstractCompilationUnit.Tuple<Unit>) operands[2], (AbstractCompilationUnit.Tuple<Marker>) operands[3]);
//                }
//            };
//        }
//
...
//         *
//         */
//        public static class UnitNode extends AbstractSyntacticItem implements Decl {
//
//            public Unit(AbstractCompilationUnit.Name name, AbstractCompilationUnit.Tuple<Decl> declarations) {
...
//                return (AbstractCompilationUnit.Tuple<Decl>) get(1);
//            }
//
//            @SuppressWarnings("unchecked")
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Unit((AbstractCompilationUnit.Name) operands[0], (AbstractCompilationUnit.Tuple<Decl>) operands[1]);
//            }
//
...
//         *
//         */
//        public static class ImportNode extends AbstractSyntacticItem implements Decl {
//            public Import(AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier> path) {
//                super(DECL_import, path);
//            }
//
//            public Import(AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier> path, boolean inclusive, AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier> names) {
...
//                return (AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier>) super.get(0);
//            }
//
//            /**
...
//             * @return
//             */
//            public AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier> getNames() {
//                return (AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier>) super.get(1);
//            }
//
//            @SuppressWarnings("unchecked")
//            @Override
...
//                switch(opcode) {
//                    case DECL_import:
//                        return new Import((AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier>) operands[0]);
//                    case DECL_importfrom:
//                        return new Import((AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier>) operands[0], false, (AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier>) operands[1]);
//                    default:
//                    case DECL_importwith:
//                        return new Import((AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier>) operands[0], true, (AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier>) operands[1]);
//                }
//            }
//
//            @Override
...
//                        r += ".";
//                    }
//                    AbstractCompilationUnit.Identifier component = path.get(i);
//                    if (component == null) {
//                        r += "*";
//                    } else {
//                        r += component.get();
...
//        }
         ...
         *
         */
        public static abstract class NamedNode<T extends Type, S extends Decl.Named<T>> extends TruffleWhileyNode<S> implements DeclNode{

            public NamedNode(S actualNode) {
                super(actualNode);
            }

            @SuppressWarnings("unchecked")
            public AbstractCompilationUnit.Tuple<Modifier> getModifiers() {
                return actualNode.getModifiers();
                // return (AbstractCompilationUnit.Tuple<Modifier>) super.get(0);
            }

            public AbstractCompilationUnit.Identifier getName() {
                return actualNode.getName(); // (AbstractCompilationUnit.Identifier) super.get(1);
            }
...
//                throw new UnsupportedOperationException();
         ...
         */
        public static abstract class CallableNode<T extends Decl.Callable> extends NamedNode<Type.Callable, T> {

            public CallableNode(T actualNode) {
                super(actualNode);
            }
            ...
            public AbstractCompilationUnit.Tuple<Template.Variable> getTemplate() {
                return actualNode.getTemplate();
//                return (AbstractCompilationUnit.Tuple<Template.Variable>) get(2);
            }

            @SuppressWarnings("unchecked")
            public AbstractCompilationUnit.Tuple<Decl.Variable> getParameters() {
                return actualNode.getParameters();
//                return (AbstractCompilationUnit.Tuple<Variable>) get(3);
            }

            @SuppressWarnings("unchecked")
            public AbstractCompilationUnit.Tuple<Decl.Variable> getReturns() {
                return actualNode.getReturns();
//                return (AbstractCompilationUnit.Tuple<Variable>) get(4);
            }

            public static Type project(AbstractCompilationUnit.Tuple<Decl.Variable> decls) {
                return Decl.Callable.project(decls);
            }
         ...
         * @see Callable
         */
        public static abstract class FunctionOrMethodNode<T extends Decl.FunctionOrMethod> extends CallableNode<T> implements DeclNode {

            public FunctionOrMethodNode(T actualNode) {
                super(actualNode);
            }

            @SuppressWarnings("unchecked")
            public AbstractCompilationUnit.Tuple<Expr> getRequires() {
                return actualNode.getRequires();
            }

            @SuppressWarnings("unchecked")
            public AbstractCompilationUnit.Tuple<Expr> getEnsures() {
                return actualNode.getEnsures();
            }

            @Override
            public Stmt.Block getBody() {
                return actualNode.getBody();
            }
        }
...
//         *
//         */
//        public static class FunctionNode extends FunctionOrMethod {
//
//            public Function(AbstractCompilationUnit.Tuple<Modifier> modifiers, AbstractCompilationUnit.Identifier name, AbstractCompilationUnit.Tuple<Template.Variable> template,
//                            AbstractCompilationUnit.Tuple<Variable> parameters, AbstractCompilationUnit.Tuple<Variable> returns, AbstractCompilationUnit.Tuple<Expr> requires,
//                            AbstractCompilationUnit.Tuple<Expr> ensures, Stmt.Block body) {
...
//                return new Function((AbstractCompilationUnit.Tuple<Modifier>) operands[0], (AbstractCompilationUnit.Identifier) operands[1],
//                        (AbstractCompilationUnit.Tuple<Template.Variable>) operands[2], (AbstractCompilationUnit.Tuple<Variable>) operands[3],
//                        (AbstractCompilationUnit.Tuple<Variable>) operands[4], (AbstractCompilationUnit.Tuple<Expr>) operands[5], (AbstractCompilationUnit.Tuple<Expr>) operands[6],
...
//        }
         ...
         *
         */
        public static class MethodNode extends FunctionOrMethodNode<Decl.Method> {

            public MethodNode(Decl.Method actualNode) {
                super(actualNode);
            }

            @Override
            public Type.Method getType() {
                return actualNode.getType();
            }

            @SuppressWarnings("unchecked")
            public Decl.Method clone(SyntacticItem[] operands) {
                return actualNode.clone(operands);
            }
            ...
            public static final Descriptor DESCRIPTOR_0 = Decl.Method.DESCRIPTOR_0;
        }
...
//         *
//         */
//        public static class PropertyNode extends Callable {
//
//            public Property(AbstractCompilationUnit.Tuple<Modifier> modifiers, AbstractCompilationUnit.Identifier name, AbstractCompilationUnit.Tuple<Template.Variable> template,
//                            AbstractCompilationUnit.Tuple<Variable> parameters, AbstractCompilationUnit.Tuple<Expr> invariant) {
//                super(DECL_property, modifiers, name, template, parameters, new AbstractCompilationUnit.Tuple<Variable>(), invariant);
//            }
//
//            public Property(AbstractCompilationUnit.Tuple<Modifier> modifiers, AbstractCompilationUnit.Identifier name, AbstractCompilationUnit.Tuple<Template.Variable> template,
//                            AbstractCompilationUnit.Tuple<Variable> parameters, AbstractCompilationUnit.Tuple<Variable> returns, AbstractCompilationUnit.Tuple<Expr> invariant) {
...
//                return (AbstractCompilationUnit.Tuple<Expr>) get(5);
//            }
//
//            @Override
//            public Stmt getBody() {
...
//                return new Property((AbstractCompilationUnit.Tuple<Modifier>) operands[0], (AbstractCompilationUnit.Identifier) operands[1],
//                        (AbstractCompilationUnit.Tuple<Template.Variable>) operands[2], (AbstractCompilationUnit.Tuple<Variable>) operands[3],
//                        (AbstractCompilationUnit.Tuple<Variable>) operands[4], (AbstractCompilationUnit.Tuple<Expr>) operands[5]);
//            }
//
...
//         *
//         */
//        public static class LambdaNode extends Callable implements Expr {
//
//            public Lambda(AbstractCompilationUnit.Tuple<Modifier> modifiers, AbstractCompilationUnit.Identifier name, AbstractCompilationUnit.Tuple<Variable> parameters, Expr body,
//                          WyilFile.Type.Callable signature) {
//                this(modifiers, name, new AbstractCompilationUnit.Tuple<>(), parameters, new AbstractCompilationUnit.Tuple<Variable>(), body, signature);
//            }
//
//
//            public Lambda(AbstractCompilationUnit.Tuple<Modifier> modifiers, AbstractCompilationUnit.Identifier name, AbstractCompilationUnit.Tuple<Template.Variable> template,
//                          AbstractCompilationUnit.Tuple<Variable> parameters, AbstractCompilationUnit.Tuple<Variable> returns, Expr body, WyilFile.Type.Callable signature) {
//                super(DECL_lambda, modifiers, name, template, parameters, returns, body, signature);
//            }
//
//            public Set<Variable> getCapturedVariables(Build.Meter meter) {
//                UsedVariableExtractor usedVariableExtractor = new UsedVariableExtractor(meter);
//                HashSet<Variable> captured = new HashSet<>();
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Lambda((AbstractCompilationUnit.Tuple<Modifier>) operands[0], (AbstractCompilationUnit.Identifier) operands[1],
//                        (AbstractCompilationUnit.Tuple<Template.Variable>) operands[2], (AbstractCompilationUnit.Tuple<Variable>) operands[3],
//                        (AbstractCompilationUnit.Tuple<Variable>) operands[4], (Expr) operands[5], (WyilFile.Type.Callable) operands[6]);
//            }
//
...
//                    return new Lambda((AbstractCompilationUnit.Tuple<Modifier>) operands[0], (AbstractCompilationUnit.Identifier) operands[1],
//                            (AbstractCompilationUnit.Tuple<Template.Variable>) operands[2], (AbstractCompilationUnit.Tuple<Variable>) operands[3],
//                            (AbstractCompilationUnit.Tuple<Variable>) operands[4], (Expr) operands[5],
...
//         *
//         */
//        public static class TypeNode extends Named<WyilFile.Type> {
//
//            public Type(AbstractCompilationUnit.Tuple<Modifier> modifiers, AbstractCompilationUnit.Identifier name, AbstractCompilationUnit.Tuple<Template.Variable> template,
//                        Decl.Variable vardecl, AbstractCompilationUnit.Tuple<Expr> invariant) {
...
//            @SuppressWarnings("unchecked")
//            public AbstractCompilationUnit.Tuple<Expr> getInvariant() {
//                return (AbstractCompilationUnit.Tuple<Expr>) get(4);
//            }
//
//            @Override
...
//                return new Type((AbstractCompilationUnit.Tuple<Modifier>) operands[0], (AbstractCompilationUnit.Identifier) operands[1],
//                        (AbstractCompilationUnit.Tuple<Template.Variable>) operands[2], (Decl.Variable) operands[3], (AbstractCompilationUnit.Tuple<Expr>) operands[4]);
//            }
//
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    Decl.Type r = new Type((AbstractCompilationUnit.Tuple<Modifier>) operands[0], (AbstractCompilationUnit.Identifier) operands[1],
//                            (AbstractCompilationUnit.Tuple<Template.Variable>) operands[2], (Decl.Variable) operands[3],
//                            (AbstractCompilationUnit.Tuple<Expr>) operands[4]);
//                    //r.setRecursive();
//                    return r;
//                }
//            };
//        }
         ...
         *
         */
        public static class VariableNode extends NamedNode<Type, Decl.Variable> {
            public VariableNode(Decl.Variable actualNode) {
                super(actualNode);
            }
            ...
            public static final Descriptor DESCRIPTOR_0 = Decl.Variable.DESCRIPTOR_0;
        }
...
//            public StaticVariable(AbstractCompilationUnit.Tuple<Modifier> modifiers, AbstractCompilationUnit.Identifier name, WyilFile.Type type, Expr initialiser) {
...
//                return new StaticVariable((AbstractCompilationUnit.Tuple<Modifier>) operands[0], (AbstractCompilationUnit.Identifier) operands[1],
...
//         * @param <T>
//         */
//        public static class LinkNode<T extends Decl.Named<?>> extends AbstractSyntacticItem {
...
//
//            public AbstractCompilationUnit.Name getName() {
//                return (AbstractCompilationUnit.Name) operands[0];
//            }
//
//            public T getTarget() {
//                if(isResolved()) {
//                    return ((AbstractCompilationUnit.Ref<T>) operands[1]).get();
//                } else {
...
//                    AbstractCompilationUnit.Ref<T> candidate = (AbstractCompilationUnit.Ref<T>) operands[i];
...
//                for(int i=1;i!=operands.length;++i) {
//                    operands[i] = heap.allocate(new AbstractCompilationUnit.Ref<>(items[i - 1]));
//                }
//            }
//
//            @Override
...
//         * @param <T>
//         */
//        public static class BindingNode<S extends WyilFile.Type, T extends Decl.Named<S>> extends AbstractSyntacticItem {
//            private S concreteType;
//
//            public Binding(Link<T> link, AbstractCompilationUnit.Tuple<WyilFile.Type> arguments) {
...
//             * @return
//             */
//            public AbstractCompilationUnit.Tuple<WyilFile.Type> getArguments() {
//                return (AbstractCompilationUnit.Tuple<WyilFile.Type>) get(1);
//            }
//
//            public void setArguments(AbstractCompilationUnit.Tuple<WyilFile.Type> arguments) {
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Binding((Link) operands[0], (AbstractCompilationUnit.Tuple<Type>) operands[1]);
//            }
//
//            @Override
//            public String toString() {
//                AbstractCompilationUnit.Identifier name = getDeclaration().getName();
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new Binding((Decl.Link) operands[0], (AbstractCompilationUnit.Tuple<Type>) operands[1]);
//                }
//            };
//        }
    }
...
//            public Variable(int opcode, AbstractCompilationUnit.Identifier name, Variance variance) {
...
//            public Type(AbstractCompilationUnit.Identifier name, Variance variance) {
//                super(TEMPLATE_type, name, variance);
//            }
//
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Type((AbstractCompilationUnit.Identifier) operands[0], getVariance());
//            }
//
//            @Override
//            public String toString() {
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new Template.Type((AbstractCompilationUnit.Identifier) operands[0], getVariance(data[0]));
//                }
//            };
//        }
//    }
     ...
     *
     */
    public interface StmtNode extends SyntacticItem {
...
//        }
         ...
         *
         */
        public static class BlockNode extends TruffleWhileyNode<Stmt.Block> implements StmtNode {
            public BlockNode(Stmt.Block actualNode) {
                super(actualNode);
            }
            ...
            public Stmt.Block clone(SyntacticItem[] operands) {
                return actualNode.clone(operands);
            }

            public static final Descriptor DESCRIPTOR_0 = Stmt.Block.DESCRIPTOR_0;
        }
...
//            public NamedBlock(AbstractCompilationUnit.Identifier name, Stmt.Block block) {
//                super(STMT_namedblock, name, block);
//            }
//
//            public AbstractCompilationUnit.Identifier getName() {
//                return (AbstractCompilationUnit.Identifier) super.get(0);
//            }
//
...
//                return new NamedBlock((AbstractCompilationUnit.Identifier) operands[0], (Block) operands[1]);
//            }
//
//            public static final Descriptor DESCRIPTOR_0 = new Descriptor(Operands.TWO, Data.ZERO, "STMT_namedblock") {
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new NamedBlock((AbstractCompilationUnit.Identifier) operands[0], (Stmt.Block) operands[1]);
//                }
//            };
//        }
//
...
//            public Assign(AbstractCompilationUnit.Tuple<LVal> lvals, AbstractCompilationUnit.Tuple<Expr> rvals) {
//                super(STMT_assign, lvals, rvals);
//            }
//
//            @SuppressWarnings("unchecked")
//            public AbstractCompilationUnit.Tuple<LVal> getLeftHandSide() {
//                return (AbstractCompilationUnit.Tuple<LVal>) super.get(0);
//            }
//
//            @SuppressWarnings("unchecked")
//            public AbstractCompilationUnit.Tuple<Expr> getRightHandSide() {
//                return (AbstractCompilationUnit.Tuple<Expr>) super.get(1);
//            }
//
//            @SuppressWarnings("unchecked")
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Assign((AbstractCompilationUnit.Tuple<LVal>) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1]);
//            }
//
...
//            public DoWhile(Expr condition, AbstractCompilationUnit.Tuple<Expr> invariant, AbstractCompilationUnit.Tuple<Decl.Variable> modified, Stmt.Block body) {
...
//                return (AbstractCompilationUnit.Tuple<Decl.Variable>) super.get(2);
//            }
//
//            public void setModified(AbstractCompilationUnit.Tuple<Decl.Variable> modified) {
//                operands[2] = modified;
//            }
//
//            @Override
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new DoWhile((Expr) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1], (AbstractCompilationUnit.Tuple<Decl.Variable>) operands[2],
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new DoWhile((Expr) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1],
//                            (AbstractCompilationUnit.Tuple<Decl.Variable>) operands[2], (Stmt.Block) operands[3]);
//                }
//            };
//        }
//
...
//            public For(Decl.StaticVariable var, AbstractCompilationUnit.Tuple<Expr> invariant, AbstractCompilationUnit.Tuple<Decl.Variable> modified, Stmt.Block trueBranch) {
//                super(STMT_for, var, invariant, modified, trueBranch);
//            }
//
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new For((Decl.StaticVariable) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1], (AbstractCompilationUnit.Tuple<Decl.Variable>) operands[2], (Stmt.Block) operands[2]);
//            }
//
...
//
//            public AbstractCompilationUnit.Tuple<Expr> getInvariant() {
//                return (AbstractCompilationUnit.Tuple<Expr>) operands[1];
//            }
//
//            public AbstractCompilationUnit.Tuple<Decl.Variable> getModified() {
//                return (AbstractCompilationUnit.Tuple<Decl.Variable>)operands[2];
//            }
//
//            public void setModified(AbstractCompilationUnit.Tuple<Decl.Variable> modified) {
//                operands[2] = modified;
...
//            public Initialiser(AbstractCompilationUnit.Tuple<Decl.Variable> variables) {
//                super(STMT_initialiservoid, variables);
//            }
//            public Initialiser(AbstractCompilationUnit.Tuple<Decl.Variable> variables, Expr initialiser) {
...
//            }
//
//            public AbstractCompilationUnit.Tuple<Decl.Variable> getVariables() {
//                return (AbstractCompilationUnit.Tuple<Decl.Variable>) get(0);
//            }
//
//            public Expr getInitialiser() {
//                return (Expr) get(1);
...
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                if(hasInitialiser()) {
//                    return new Initialiser((AbstractCompilationUnit.Tuple<Decl.Variable>) operands[0], (Expr) operands[1]);
//                } else {
//                    return new Initialiser((AbstractCompilationUnit.Tuple<Decl.Variable>) operands[0]);
//                }
//            }
//
...
//        }
         ...
         *
         */
        public static class ReturnNode extends TruffleWhileyNode<Stmt.Return> implements StmtNode {
            public ReturnNode(Stmt.Return actualNode) {
                super(actualNode);
            }


            public boolean hasReturn() {
                return actualNode.hasReturn();
            }

            @SuppressWarnings("unchecked")
            public Expr getReturn() {
                return actualNode.getReturn();
            }
            ...
            public static final Descriptor DESCRIPTOR_0a = Stmt.Return.DESCRIPTOR_0a;

            public static final Descriptor DESCRIPTOR_0b = Stmt.Return.DESCRIPTOR_0b;
        }
...
//            public Switch(Expr condition, AbstractCompilationUnit.Tuple<Case> cases) {
...
//                return (AbstractCompilationUnit.Tuple<Case>) get(1);
//            }
//
//            @SuppressWarnings("unchecked")
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Switch((Expr) operands[0], (AbstractCompilationUnit.Tuple<Case>) operands[1]);
//            }
//
...
//
//            public Case(AbstractCompilationUnit.Tuple<Expr> conditions, Stmt.Block block) {
...
//                return (AbstractCompilationUnit.Tuple<Expr>) get(0);
//            }
//
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Case((AbstractCompilationUnit.Tuple<Expr>) operands[0], (Stmt.Block) operands[1]);
//            }
//
...
//            public While(Expr condition, AbstractCompilationUnit.Tuple<Expr> invariant, AbstractCompilationUnit.Tuple<Decl.Variable> modified, Stmt.Block body) {
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new While((Expr) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1], (AbstractCompilationUnit.Tuple<Decl.Variable>) operands[2],
//                        (Stmt.Block) operands[3]);
//            }
//
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new While((Expr) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1],
//                            (AbstractCompilationUnit.Tuple<Decl.Variable>) operands[2], (Stmt.Block) operands[3]);
//                }
//            };
//        }
...
//        }
        ...
        public abstract static class AbstractExprNode<T extends Expr.AbstractExpr> extends TruffleWhileyNode<T> implements ExprNode {
            public AbstractExprNode(T actualNode) {
                super(actualNode);
            }
...
//        }
         ...
         *
         */
        public static class ConstantNode extends AbstractExprNode<Expr.Constant> implements ExprNode {
            public ConstantNode(Expr.Constant actualNode) {
                super(actualNode);
            }
            ...
            public Expr.Constant clone(SyntacticItem[] operands) {
                return actualNode.clone(operands);
            }
            ...
            public static final Descriptor DESCRIPTOR_0 = Expr.Constant.DESCRIPTOR_0;
        }
//
//        /**
...
//
//            public Invoke(Decl.Binding<Type.Callable, Decl.Callable> binding, AbstractCompilationUnit.Tuple<Expr> arguments) {
...
//            @SuppressWarnings("unchecked")
//            public AbstractCompilationUnit.Tuple<Expr> getOperands() {
//                return (AbstractCompilationUnit.Tuple<Expr>) get(1);
//            }
//
//            @SuppressWarnings("unchecked")
//            @Override
//            public Invoke clone(SyntacticItem[] operands) {
//                return new Invoke((Decl.Binding<Type.Callable, Decl.Callable>) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//                            (AbstractCompilationUnit.Tuple<Expr>) operands[1]);
//                }
//            };
//        }
//
...
//
//            public IndirectInvoke(Type type, Expr source, AbstractCompilationUnit.Tuple<Expr> arguments) {
...
//                return (AbstractCompilationUnit.Tuple<Expr>) get(2);
//            }
//
//            @SuppressWarnings("unchecked")
//            @Override
...
//                        (AbstractCompilationUnit.Tuple<Expr>) operands[2]);
//            }
//
//            @Override
//            public String toString() {
...
//                super(opcode, new AbstractCompilationUnit.Tuple<>(parameters), body);
//            }
//
//            public Quantifier(int opcode, AbstractCompilationUnit.Tuple<Decl.StaticVariable> parameters, Expr body) {
...
//
//            @SuppressWarnings("unchecked")
//            public AbstractCompilationUnit.Tuple<Decl.StaticVariable> getParameters() {
//                return (AbstractCompilationUnit.Tuple<Decl.StaticVariable>) get(0);
//            }
//
//            @Override
//            public Expr getOperand() {
...
//                super(EXPR_logicaluniversal, new AbstractCompilationUnit.Tuple<>(parameters), body);
//            }
//
//            public UniversalQuantifier(AbstractCompilationUnit.Tuple<Decl.StaticVariable> parameters, Expr body) {
...
//                return new UniversalQuantifier((AbstractCompilationUnit.Tuple<Decl.StaticVariable>) operands[0], (Expr) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//                super(EXPR_logicalexistential, new AbstractCompilationUnit.Tuple<>(parameters), body);
//            }
//
//            public ExistentialQuantifier(AbstractCompilationUnit.Tuple<Decl.StaticVariable> parameters, Expr body) {
...
//            @Override
//            public Expr clone(SyntacticItem[] operands) {
//                return new ExistentialQuantifier((AbstractCompilationUnit.Tuple<Decl.StaticVariable>) operands[0], (Expr) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//            public LogicalAnd(AbstractCompilationUnit.Tuple<Expr> operands) {
...
//            @Override
//            public AbstractCompilationUnit.Tuple<Expr> getOperands() {
//                return (AbstractCompilationUnit.Tuple<Expr>) super.get(0);
//            }
//
//            @Override
//            public Expr clone(SyntacticItem[] operands) {
//                return new LogicalAnd((AbstractCompilationUnit.Tuple<Expr>) operands[0]);
//            }
//
//            @Override
//            public String toString() {
...
//            public LogicalOr(AbstractCompilationUnit.Tuple<Expr> operands) {
...
//            @Override
//            public Expr clone(SyntacticItem[] operands) {
//                return new LogicalOr((AbstractCompilationUnit.Tuple<Expr>) operands[0]);
//            }
//
//            @Override
//            public String toString() {
...
//            public BitwiseAnd(Type type, AbstractCompilationUnit.Tuple<Expr> operands) {
...
//            @Override
//            public Expr clone(SyntacticItem[] operands) {
//                return new BitwiseAnd((Type) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//            public BitwiseOr(Type type, AbstractCompilationUnit.Tuple<Expr> operands) {
...
//            @Override
//            public Expr clone(SyntacticItem[] operands) {
//                return new BitwiseOr((Type) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//            public BitwiseXor(Type type, AbstractCompilationUnit.Tuple<Expr> operands) {
...
//            @Override
//            public Expr clone(SyntacticItem[] operands) {
//                return new BitwiseXor((Type) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//            public FieldDereference(Type type, Expr operand, AbstractCompilationUnit.Identifier field) {
...
//                return (AbstractCompilationUnit.Identifier) super.get(2);
//            }
//
//            @Override
//            public Expr clone(SyntacticItem[] operands) {
//                return new FieldDereference((Type) operands[0], (Expr) operands[1], (AbstractCompilationUnit.Identifier) operands[2]);
//            }
//
//            @Override
//            public String toString() {
...
//            public ArrayInitialiser(Type type, AbstractCompilationUnit.Tuple<Expr> elements) {
...
//                return new ArrayInitialiser((Type) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//            public RecordAccess(Type type, Expr lhs, AbstractCompilationUnit.Identifier rhs) {
...
//             */
//            public AbstractCompilationUnit.Identifier getField() {
//                return (AbstractCompilationUnit.Identifier) get(2);
//            }
//
//            public void setMove() {
...
//                return new RecordAccess((Type) operands[0], (Expr) operands[1], (AbstractCompilationUnit.Identifier) operands[2]);
//            }
//
//            @Override
//            public String toString() {
...
//                            (AbstractCompilationUnit.Identifier) operands[2]);
//                    r.setMove();
//                    return r;
//                }
//            };
...
//            public TupleInitialiser(Type type, AbstractCompilationUnit.Tuple<Expr> operands) {
//                super(EXPR_tupleinitialiser, type, operands);
//            }
//
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new TupleInitialiser((Type) operands[0], (AbstractCompilationUnit.Tuple<Expr>) operands[1]);
//            }
//
//            @Override
//            public AbstractCompilationUnit.Tuple<Expr> getOperands() {
...
//
//            public RecordInitialiser(Type type, AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier> fields, AbstractCompilationUnit.Tuple<Expr> operands) {
...
//            @Override
//            public AbstractCompilationUnit.Tuple<Expr> getOperands() {
//                return (AbstractCompilationUnit.Tuple<Expr>) super.get(2);
//            }
//
//            @SuppressWarnings("unchecked")
//            @Override
//            public RecordInitialiser clone(SyntacticItem[] operands) {
//                return new RecordInitialiser((Type) operands[0], (AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Identifier>) operands[1],
//                        (AbstractCompilationUnit.Tuple<Expr>) operands[2]);
//            }
//
...
//            public RecordUpdate(Type type, Expr lhs, AbstractCompilationUnit.Identifier mhs, Expr rhs) {
...
//                return new RecordUpdate((Type) operands[0], (Expr) operands[1], (AbstractCompilationUnit.Identifier) operands[2],
//                        (Expr) operands[3]);
//            }
//
//            @Override
...
//        }
    ...
    public static interface TypeNode extends SyntacticItem {

//        public static final Any Any = new Any();
//        public static final Void Void = new Void();
//        public static final Bool Bool = new Bool();
//        public static final Byte Byte = new Byte();
//        public static final Int Int = new IntNode();
...
//        public static final Null Null = new Null();
        ...
        public interface AtomNode extends TypeNode {
        }

        public interface PrimitiveNode extends AtomNode {

        }

        static abstract class AbstractTypeNode<T extends Type.AbstractType> extends TruffleWhileyNode<T> implements TypeNode {
            AbstractTypeNode(T actualNode) {
                super(actualNode);
            }
            ...
            @Override
            public Type dimension(int nth) {
                return actualNode.dimension(nth);
            }
            ...
            @Override
            public <T extends Type> T as(Class<T> kind) {
                return actualNode.as(kind);
            }

            @Override
            public <T extends Type> List<T> filter(Class<T> kind) {
                return actualNode.filter(kind);
            }
        }
//
//        /**
...
//        }
         ...
         *
         */
        public static class IntNode extends AbstractTypeNode<Type.Int> implements PrimitiveNode {
            public IntNode(Type.Int actualNode) {
                super(actualNode);
            }
            ...
            @Override
            public Type substitute(java.util.function.Function<Object, SyntacticItem> binding) {
                return actualNode.substitute(binding);
            }

            @Override
            public Type.Int clone(SyntacticItem[] operands) {
                return actualNode.clone(operands);
            }
            ...
            public static final Descriptor DESCRIPTOR_0 = Type.Int.DESCRIPTOR_0;
        }
...
//                return (AbstractCompilationUnit.Identifier) get(1);
//            }
//
//            @Override
...
//                this(new AbstractCompilationUnit.Value.Bool(isOpen), fields);
//            }
//
//            public Record(boolean isOpen, WyilFile.Tuple<AbstractCompilationUnit.Identifier> fields, WyilFile.Tuple<Type> types) {
//                this(new AbstractCompilationUnit.Value.Bool(isOpen), zip(fields,types));
//            }
//
//            public Record(boolean isOpen, AbstractCompilationUnit.Identifier field, Type type) {
//                this(new AbstractCompilationUnit.Value.Bool(isOpen), new WyilFile.Tuple<>(new Type.Field(field, type)));
//            }
//
//            public Record(AbstractCompilationUnit.Value.Bool isOpen, WyilFile.Tuple<Type.Field> fields) {
...
//                AbstractCompilationUnit.Value.Bool flag = (AbstractCompilationUnit.Value.Bool) get(0);
//                return flag.get();
//            }
//
//            public Type getField(AbstractCompilationUnit.Identifier fieldName) {
//                WyilFile.Tuple<Field> fields = getFields();
//                for (int i = 0; i != fields.size(); ++i) {
//                    Field vd = fields.get(i);
//                    AbstractCompilationUnit.Identifier declaredFieldName = vd.getName();
...
//                return new Record((AbstractCompilationUnit.Value.Bool) operands[0], (WyilFile.Tuple<Type.Field>) operands[1]);
//            }
//
//            /**
...
//            }
//
//            private static WyilFile.Tuple<Type.Field> zip(WyilFile.Tuple<AbstractCompilationUnit.Identifier> fields, WyilFile.Tuple<Type> types) {
...
//
//            public Field(AbstractCompilationUnit.Identifier name, Type type) {
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Field((AbstractCompilationUnit.Identifier) operands[0], (Type) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//            public Universal(AbstractCompilationUnit.Identifier name) {
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Universal((AbstractCompilationUnit.Identifier) operands[0]);
//            }
//
//            @Override
//            public Type substitute(java.util.function.Function<Object, SyntacticItem> binding) {
...
//
//            public Recursive(AbstractCompilationUnit.Ref<Type> reference) {
...
//
//            public Type getHead() {
//                AbstractCompilationUnit.Ref<Type> r = (AbstractCompilationUnit.Ref<Type>) get(0);
//                return r.get();
//            }
//
...
//                return new Recursive((AbstractCompilationUnit.Ref<Type>) operands[0]);
//            }
//
//            @Override
//            public String toString() {
...
//        }
     ...
     *
     */
    public interface ModifierNode extends SyntacticItem {

        public static final class PublicNode extends TruffleWhileyNode<Modifier.Public> implements ModifierNode {
            public PublicNode(Modifier.Public actualNode) {
                super(actualNode);
            }
            ...
            public static final Descriptor DESCRIPTOR_0 = Modifier.Public.DESCRIPTOR_0;
        }
...
//        }
        ...
        public static final class ExportNode extends TruffleWhileyNode<Modifier.Export> implements ModifierNode {
            public ExportNode(Modifier.Export actualNode) {
                super(actualNode);
            }
            ...
            public static final Descriptor DESCRIPTOR_0 = Modifier.Export.DESCRIPTOR_0;
        }
...
//                super(ATTR_error, BigInteger.valueOf(errcode).toByteArray(), target, new AbstractCompilationUnit.Tuple<>());
//            }
//
//            public SyntaxError(int errcode, SyntacticItem target, AbstractCompilationUnit.Tuple<SyntacticItem> context) {
...
//                return (AbstractCompilationUnit.Tuple<SyntacticItem>) operands[1];
//            }
//
//            /**
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new SyntaxError(getErrorCode(), operands[0], (AbstractCompilationUnit.Tuple<SyntacticItem>) operands[1]);
//            }
//
//            @Override
...
//                    return new SyntaxError(errcode, operands[0], (AbstractCompilationUnit.Tuple<SyntacticItem>) operands[1]);
//                }
//            };
//        }
//
//        public static class StackFrame extends AbstractSyntacticItem {
//            public StackFrame(Decl.Named<?> context, AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Value> arguments) {
...
//                return (AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Value>) operands[1];
//            }
//
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new StackFrame((Decl.Callable) operands[0], (AbstractCompilationUnit.Tuple) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new StackFrame((Decl.Named) operands[0], (AbstractCompilationUnit.Tuple<AbstractCompilationUnit.Value>) operands[1]);
//                }
//            };
//        }
//
//        public static class CounterExample extends AbstractSyntacticItem {
//            public CounterExample(AbstractCompilationUnit.Value.Dictionary mapping) {
//                super(ATTR_counterexample,mapping);
//            }
//
//            public AbstractCompilationUnit.Value.Dictionary getMapping() {
//                return (AbstractCompilationUnit.Value.Dictionary) operands[0];
//            }
//
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new CounterExample((AbstractCompilationUnit.Value.Dictionary) operands[0]);
//            }
//
//            @Override
//            public String toString() {
...
//            @Override
//            public boolean equals(Object o) {
//                if(o instanceof wybs.util.AbstractCompilationUnit.Ref) {
//                    wybs.util.AbstractCompilationUnit.Ref<?> r = (wybs.util.AbstractCompilationUnit.Ref<?>) o;
//                    return get() == r.get();
//                }
//                return false;
//            }
...
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new wybs.util.AbstractCompilationUnit.Ref(operands[0]);
//            }
//
...
//
//            @Override
//            public wybs.util.AbstractCompilationUnit.Pair<K, V> clone(SyntacticItem[] operands) {
//                return new wybs.util.AbstractCompilationUnit.Pair<>((K) operands[0], (V) operands[1]);
//            }
//
//            @Override
//            public String toString() {
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new wybs.util.AbstractCompilationUnit.Pair<>(operands[0], operands[1]);
//                }
//            };
//        }
         ...
         * @param <T>
         */
    public static class TupleNode<T extends SyntacticItem> extends TruffleWhileyNode<Tuple<T>> implements Iterable<T> {

        public TupleNode(Tuple<T> actualNode) {
            super(actualNode);
        }
         ...
         * @return
         */
        public Tuple<T> appendAll(wybs.util.AbstractCompilationUnit.Tuple<T> items) {
            return actualNode.appendAll(items);
        }
        ...
        public <S extends SyntacticItem> Tuple<T> removeAll(Collection<S> items) {
            return actualNode.removeAll(items);
        }
        ...
        public String toBareString() {
            return actualNode.toBareString();
        }

        @Override
        public Iterator<T> iterator() {
            return actualNode.iterator();
        }

        public static final SyntacticItem.Descriptor DESCRIPTOR_0 = Tuple.DESCRIPTOR_0;
    }
     ...
     *
     */
    public static class IdentifierNode extends TruffleWhileyNode<Identifier> implements CompilationUnit.Identifier {
        public IdentifierNode(Identifier actualNode) {
            super(actualNode);
        }
        ...
        public static final SyntacticItem.Descriptor DESCRIPTOR_0 = Identifier.DESCRIPTOR_0;
    }
...
//            public Name(wybs.util.AbstractCompilationUnit.Identifier... components) {
...
//
//            @Override
//            public wybs.util.AbstractCompilationUnit.Identifier get(int i) {
//                return (wybs.util.AbstractCompilationUnit.Identifier) super.get(i);
//            }
//
//            @Override
//            public wybs.util.AbstractCompilationUnit.Identifier[] getAll() {
//                return (wybs.util.AbstractCompilationUnit.Identifier[]) super.getAll();
//            }
//
//            public wybs.util.AbstractCompilationUnit.Identifier getLast() {
//                return get(size()-1);
//            }
//
//            public wybs.util.AbstractCompilationUnit.Identifier[] getPath() {
//                wybs.util.AbstractCompilationUnit.Identifier[] components = new wybs.util.AbstractCompilationUnit.Identifier[size()-1];
...
//
//            @Override
//            public wybs.util.AbstractCompilationUnit.Name clone(SyntacticItem[] operands) {
//                return new wybs.util.AbstractCompilationUnit.Name(ArrayUtils.toArray(wybs.util.AbstractCompilationUnit.Identifier.class, operands));
//            }
//
//            @Override
//            public String toString() {
...
//            }
//
//            private static wybs.util.AbstractCompilationUnit.Identifier[] path2ids(Path.ID id) {
//                wybs.util.AbstractCompilationUnit.Identifier[] ids = new wybs.util.AbstractCompilationUnit.Identifier[id.size()];
//                for(int i=0;i!=id.size();++i) {
//                    ids[i] = new wybs.util.AbstractCompilationUnit.Identifier(id.get(i));
//                }
//                return ids;
//            }
//
...
//        }
     ...
     *
     */
    public abstract static class ValueNode<T extends Value> extends TruffleWhileyNode<T> {

        public ValueNode(T actualNode) {
            super(actualNode);
        }
...
//        public static class Null extends wybs.util.AbstractCompilationUnit.Value {
//            public Null() {
//                super(ITEM_null);
//            }
//
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new wybs.util.AbstractCompilationUnit.Value.Null();
//                }
//            };
//        }
//
//        public static class Bool extends wybs.util.AbstractCompilationUnit.Value {
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new wybs.util.AbstractCompilationUnit.Value.Bool(data[0] == 1);
//                }
//            };
//        }
//
//        public static class Byte extends wybs.util.AbstractCompilationUnit.Value {
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new wybs.util.AbstractCompilationUnit.Value.Byte(data[0]);
//                }
//            };
//        }


        public static class IntNode extends ValueNode<Value.Int> {

            public IntNode(Value.Int actualNode) {
                super(actualNode);
            }
            ...
            public BigInteger unwrap() {
                return actualNode.unwrap();
            }

            public Value.Int clone(SyntacticItem[] operands) {
                return actualNode.clone(operands);
            }
            ...
            public static final SyntacticItem.Descriptor DESCRIPTOR_0 = Value.Int.DESCRIPTOR_0;
        }
//
//        public static class Decimal extends wybs.util.AbstractCompilationUnit.Value {
//
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new wybs.util.AbstractCompilationUnit.Value.Decimal(data);
//                }
//            };
//        }
//
//
//        public static class UTF8 extends wybs.util.AbstractCompilationUnit.Value {
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new wybs.util.AbstractCompilationUnit.Value.UTF8(data);
//                }
//            };
//        }
//
//        public static class Array extends wybs.util.AbstractCompilationUnit.Value {
//
//            public Array(wybs.util.AbstractCompilationUnit.Value... stmts) {
//                super(ITEM_array, stmts);
//            }
//
//            public Array(Collection<? extends wybs.util.AbstractCompilationUnit.Value> stmts) {
...
//
//            @Override
//            public wybs.util.AbstractCompilationUnit.Value get(int i) {
//                return (wybs.util.AbstractCompilationUnit.Value) super.get(i);
//            }
//
//            @Override
//            public Array clone(SyntacticItem[] operands) {
//                return new Array(ArrayUtils.toArray(wybs.util.AbstractCompilationUnit.Value.class, operands));
//            }
//
//            @Override
//            public String toString() {
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new wybs.util.AbstractCompilationUnit.Value.Array(ArrayUtils.toArray(wybs.util.AbstractCompilationUnit.Value.class, operands));
//                }
//            };
//        }
//
//        public static class Dictionary extends wybs.util.AbstractCompilationUnit.Value {
//            public Dictionary(wybs.util.AbstractCompilationUnit.Pair<wybs.util.AbstractCompilationUnit.Identifier, wybs.util.AbstractCompilationUnit.Value>... entries) {
//                super(ITEM_dictionary,entries);
//            }
//
//            @Override
//            public SyntacticItem clone(SyntacticItem[] operands) {
//                return new Dictionary(ArrayUtils.toArray(wybs.util.AbstractCompilationUnit.Pair.class, operands));
//            }
//
//            @Override
//            public wybs.util.AbstractCompilationUnit.Pair<wybs.util.AbstractCompilationUnit.Identifier, wybs.util.AbstractCompilationUnit.Value> get(int i) {
//                return (wybs.util.AbstractCompilationUnit.Pair<wybs.util.AbstractCompilationUnit.Identifier, wybs.util.AbstractCompilationUnit.Value>) super.get(i);
//            }
//
//            @Override
//            public Object unwrap() {
...
//                for (int i = 0; i != size(); ++i) {
//                    wybs.util.AbstractCompilationUnit.Pair<wybs.util.AbstractCompilationUnit.Identifier, wybs.util.AbstractCompilationUnit.Value> entry = get(i);
...
//                @Override
//                public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                    return new wybs.util.AbstractCompilationUnit.Value.Dictionary(ArrayUtils.toArray(wybs.util.AbstractCompilationUnit.Pair.class, operands));
//                }
//            };
//        }
    }
...
//             *
//             */
//            public class Span extends AbstractSyntacticItem implements wybs.util.AbstractCompilationUnit.Attribute {
//
//                public Span(SyntacticItem item, int start, int end) {
//                    this(item, new wybs.util.AbstractCompilationUnit.Value.Int(start), new wybs.util.AbstractCompilationUnit.Value.Int(end));
//                }
//
//                public Span(SyntacticItem target, wybs.util.AbstractCompilationUnit.Value.Int start, wybs.util.AbstractCompilationUnit.Value.Int end) {
...
//                 * @return
//                 */
//                public wybs.util.AbstractCompilationUnit.Value.Int getStart() {
//                    return (wybs.util.AbstractCompilationUnit.Value.Int) get(1);
//                }
//
//                /**
//                 * Get the integer offset from the start of the stream where this
...
//                 * @return
//                 */
//                public wybs.util.AbstractCompilationUnit.Value.Int getEnd() {
//                    return (wybs.util.AbstractCompilationUnit.Value.Int) get(2);
//                }
//
//                @Override
//                public Span clone(SyntacticItem[] operands) {
//                    return new Span(operands[0], (wybs.util.AbstractCompilationUnit.Value.Int) operands[1], (wybs.util.AbstractCompilationUnit.Value.Int) operands[2]);
//                }
//
...
//                    @Override
//                    public SyntacticItem construct(int opcode, SyntacticItem[] operands, byte[] data) {
//                        return new wybs.util.AbstractCompilationUnit.Attribute.Span(operands[0], (wybs.util.AbstractCompilationUnit.Value.Int) operands[1], (wybs.util.AbstractCompilationUnit.Value.Int) operands[2]);
//                    }
//                };
//            }
//        }
